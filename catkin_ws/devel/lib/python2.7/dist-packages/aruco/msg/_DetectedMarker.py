...
"""autogenerated by genpy from aruco/DetectedMarker.msg. Do not edit."""
import sys
...
class DetectedMarker(genpy.Message):
  _md5sum = "912fbebbdbec5fb62c145058291e2413"
  _type = "aruco/DetectedMarker"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DetectedMarker, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_i3I.pack(_x.id, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
